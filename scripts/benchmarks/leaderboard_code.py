# Add this after your existing result saving/printing code
...
new_entry = {
    ...
    "benchmark": "pytorch_matmul" if "pytorch" in __file__ else "tensorflow_cnn",
    "score": results["avg_time"] if "pytorch" in __file__ else results["total_duration"],
